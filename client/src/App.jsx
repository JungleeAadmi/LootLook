...
const Icons = {
  ...
  // ... other icons reused from previous ...
...
function App() {
  ...
  return (
    <div className={`app-wrapper ${theme}`}>
        ...
        <div className="nav-content">
            ...
            {menuOpen && (
                <div className="menu-dropdown">
                    ...
                    <div className="menu-item" onClick={fetchItems}>↻ Sync</div>
                    ...
                    <div className="menu-item danger" onClick={logout}>Logout</div>
                </div>
            )}
        </div>
      </nav>
      ...
      {/* Modals (History, Edit, Image) - Keeping logic, just rendering */}
