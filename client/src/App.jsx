        ...
        <div className="price-group">
             ...
             {hasChange && (
                 <span className={`prev-price ${trend}`}>
                     {trend === 'down' ? '▼' : '▲'} {item.previous_price.toLocaleString()}
                 </span>
             )}
        </div>
      );
        ...
        <section className="items-grid">
            {filteredItems.map(item => (
                <article key={item.id} className={`item-card trend-${getTrend(item.current_price, item.previous_price)}`}>
                    ...
                    {/* ROW 1: SNIP (30% Height) */}
                    <div className="row-snip" onClick={(e) => openImage(e, item)}>
                    ...
                    <div className="card-text-body">
                        ...
                        {/* ROW 3: PRICE (Left) | DATE (Right) */}
                        <div className="row-meta-split">
                            {renderPriceBox(item)}
                    ...
                    {/* ROW 5: ACTIONS (3x2 Grid = 6 Buttons) */}
