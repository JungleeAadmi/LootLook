...
const Icons = {
  ...
  Web: () => <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>,
            ...
            {filteredItems.map(item => (
                <article key={item.id} className={`item-card trend-${getTrend(item.current_price, item.previous_price)}`}>
                    ...
                    <div className="card-actions">
                        ...
                        <button onClick={() => openHistory(item)} className="action-btn graph" title="History Graph"><Icons.Graph /></button>
                        ...
                        <a href={item.url} target="_blank" rel="noreferrer" className="action-btn visit" title="Go to Website"><Icons.Web /></a>
